...
const CandyMachine: React.FC<CandyMachineProps> = ({ walletAddress }) => {
        ...
        <div className="machine-container">
            <div className="gif-container">
                <div className="gif-grid">
                    {/* Map through your GIFs here */}
                    <div className="gif-item">
                        <img src="your-gif-url" alt="GIF" />
                    </div>
                </div>
            </div>
            <div className="timer-container">
                <p className="timer-header">Drop Date:</p>
                <p className="timer-value">Your drop date here</p>
            </div>
            <p>Items Minted:</p>
